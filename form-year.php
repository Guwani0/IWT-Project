...
<br><br>
    ...
    <center><div><br> <fieldset class="line">
        <h2 class ="head"><b>ARTIST OF THE YEAR</b></h2><br>
    
        <form method="POST" action="insert-year.php" onsubmit="return validateForm()">
           
            <div class="email">Email :  <input class="box" type="text" name="vemail" required></div><br><br>
            <div class="choose">Choose Your Favourite Superstar</div><br><br><input type="radio" id="taylor" name="YEAR" value="TAYLOR SWIFT" class="radio"><br>
            <label class="label label-1" for="taylor">TAYLOR SWIFT</label><br><br>

            <input type="radio" id="harry" name="YEAR" value="HARRY STYLES"class="radio"><br>
            <label class="label label-2" for="harry">HARRY STYLES</label><br><br>

            <input type="radio" id="lana" name="YEAR" value="LANA DEL REY"class="radio"><br>
            <label class="label label-3" for="lana">LANA DEL REY</label><br><br>

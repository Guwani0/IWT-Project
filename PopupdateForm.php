...
<header class="header">
    ...
    <br><br>
    <form action="updatePop.php" method="POST" class="update">
        
            

            <div class="email">Email :  <input class="box" type="text" name="vemail" required></div><br><br>

            <div class="choose">Choose Your Favourite Superstar</div><br><br><input type="radio" id="camila" name="POP" value="CAMILA CABELLO" class="radio">
            <label class="label" for="camila">CAMILA CABELLO</label><br><br>

            <input type="radio" id="gaga" name="POP" value="LADY GAGA"class="radio">
            <label class="label" for="gaga">LADY GAGA</label><br><br>

            <input type="radio" id="weeknd" name="POP" value="THE WEEKND"class="radio">
            <label class="label" for="weeknd">THE WEEKND</label><br><br>

...
<head>
    ...
    <link rel="stylesheet" href="styles/performencehilight.css">
...
<body>
    ...
    <div class="main1">
        <p class="gall2" style="font-family: Future; color:gold; text-shadow:5px 5px 10px black;">Winners 2023</p>
    </div>
    ...
    <div class="mb">
        <div class="row1">
        <!--<div class="mb5">-->
            <video src="video/v11.mp4" controls  class="v1" id="vid1"></video>
        <!--</div>-->

        <!--<div class="mb1">-->
            <video src="video/v12.mp4" controls  class="v1" id="vid2"></video>
        <!--</div>-->

       <!-- <div class="mb2">-->
            <video src="video/v113.mp4" controls class="v1" id="vid3"></video>
       <!-- </div>-->
        </div>

        <!--<div class="mb3">-->
            <video src="video/5.mp4" controls class="v1" id="vid4"></video>
        <!--</div>-->

        <!--<div class="mb4">-->
            <video src="video/7.mp4 " controls class="v1" id="vid5"></video>
        <!--</div>-->

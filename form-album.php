...
<br><br>
    ...
    <center><div><br> <fieldset class="line">
        <h2 class ="head"><b>FAVOURITE ALBUM</b></h2><br>
    
        <form method="POST" action="insert-album.php" onsubmit="return validateForm()">
           
            <div class="email">Email :  <input class="box" type="text" name="vemail" required></div><br><br>
            <div class="choose">Choose Your Favourite Superstar</div><br><br><input type="radio" id="mars" name="ALBUM" value="24K MAGIC - BRUNO MARS" class="radio"><br>
            <label class="label label-1" for="mars">24K MAGIC - BRUNO MARS</label><br><br>
            <input type="radio" id="olivia" name="ALBUM" value="GUTS - OLIVIA RODRIGO"class="radio"><br>
            <label class="label label-2" for="olivia">GUTS - OLIVIA RODRIGO</label><br><br>
            <input type="radio" id="gomez" name="ALBUM" value="RARE - SELENA GOMEZ"class="radio"><br>
            <label class="label label-3" for="gomez">RARE - SELENA GOMEZ</label><br><br>

...
<header class="header">
    ...
    <div class="all">
            ...
            <div class="choose">Choose Your Favourite Superstar</div><br><br><input type="radio" id="taylor" name="YEAR" value="TAYLOR SWIFT" class="radio">
            <label class="label" for="taylor">TAYLOR SWIFT</label><br><br>

            <input type="radio" id="harry" name="YEAR" value="HARRY STYLES"class="radio">
            <label class="label" for="harry">HARRY STYLES</label><br><br>

            <input type="radio" id="lana" name="YEAR" value="LANA DEL REY"class="radio">
            <label class="label" for="lana">LANA DEL REY</label>
            </div>

...
<br><br>
    ...
    <center><div><br> <fieldset class="line">
        <h2 class ="head"><b>MOST POPULAR ARTIST</b></h2><br>
    
        <form method="POST" action="insert-pop.php" onsubmit="return validateForm()">
           
            <div class="email">Email :  <input class="box" type="text" name="vemail" required></div><br><br>
            <div class="choose">Choose Your Favourite Superstar</div><br><br><input type="radio" id="camila" name="POP" value="CAMILA CABELLO" class="radio"><br>
            <label class="label label-1" for="camila">CAMILA CABELLO</label><br><br>

            <input type="radio" id="gaga" name="POP" value="LADY GAGA"class="radio"><br>
            <label class="label label-2" for="gaga">LADY GAGA</label><br><br>

            <input type="radio" id="weeknd" name="POP" value="THE WEEKND"class="radio"><br>
            <label class="label label-3" for="weeknd">THE WEEKND</label><br><br>
    ...
    <script>
                function validateForm(){
                    var radios = document.getElementsByName("POP");
                    var formValid = false;

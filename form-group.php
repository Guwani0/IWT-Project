...
<br><br>
    ...
    <center><div><br> <fieldset class="line">
        <h2 class ="head"><b>GROUP OF THE YEAR</b></h2><br>
    
        <form method="POST" action="insert-group.php" onsubmit="return validateForm()">
           
            <div class="email">Email :  <input class="box" type="text" name="vemail" required></div><br><br>
            <div class="choose">Choose Your Favourite Superstar</div><br><br><input type="radio" id="bts" name="GROUP" value="BTS" class="radio"><br>
            <label class="label label-1" for="bts">BTS</label><br><br>

            <input type="radio" id="blackpink" name="GROUP" value="BLACKPINK"class="radio"><br>
            <label class="label label-2" for="blackpink">BLACKPINK</label><br><br>

            <input type="radio" id="maroon" name="GROUP" value="MAROON 5"class="radio"><br>
            <label class="label label-3" for="maroon">MAROON 5</label><br><br>
